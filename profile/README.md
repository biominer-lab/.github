...
|------------|:----------:|:------------------:|-------------------------|
| 多组学数据集 | [TCOA DataHub](https://github.com/biominer-lab/datahub)<br/>[SEQC DataHub](https://github.com/biominer-lab/seqc-datahub)  |   同过渡期软件系统   | GitHub仓库，用于Metadata的协作与版本控制|
| 元数据QC & QA系统 | [Metabase](https://github.com/yjcyxky/metabase)<br/>[Metadata Validator](https://github.com/yjcyxky/metadata-tool) |   同过渡期软件系统   |元数据QC/QA |
| 标准化分析流程与系统 | [ClinicoOmics](https://github.com/yjcyxky/clinico-omics) | 同过渡期软件系统 |标准化分析流程管理与运行 |

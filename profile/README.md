...
| 多组学数据管理系统 | [Metabase](https://github.com/yjcyxky/metabase) + [BioPoem](https://github.com/yjcyxky/biopoem)<br/>(NODE/GSA/SRA + OSS) | [BioMiner](https://github.com/yjcyxky/biominer) + [BioPoem](https://github.com/yjcyxky/biopoem)<br/> (NODE/GSA/SRA + OSS) |Metabase - 多组学数据集相关元数据管理<br/><br/>Biopoem - 数据高速传输(测序公司 ---> 集群 ---> NODE ---> 阿里云/集群)<br/><br/>NODE/GSA/SRA - Level 1/2数据的存储<br/><br/>OSS - Level3数据的存储 |
